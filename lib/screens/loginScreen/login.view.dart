      ...
      body: GestureDetector(
        ...
        child: Column(
          ...
          children: [
            ...
            //SizedBox(height: 8.0,),
            Padding(
              padding: (MediaQuery.of(context).size.width>500)?const EdgeInsets.fromLTRB(150.0, 10.0, 25.0, 10.0):const EdgeInsets.fromLTRB(35.0, 50.0, 25.0, 12.0),
              child: RichText(
                text: TextSpan(
                                ...
                                text: TextSpan(
                                  children: [
                                    TextSpan(
                                      children: [
                                        TextSpan(
                                          text: AppLocalizations.of(context)!.logintext2,
                                          style: TextStyle(
                                            color: themeFlag
                                                ? AppColors.metgoldenColor
                                                : AppColors.blueZodiacTwo,
                                    ...
                                    text: TextSpan(
                                      children: [
                                        TextSpan(
                                          children: [
                                            TextSpan(
                                              text: AppLocalizations.of(context)!.logintext3,
                                              style: TextStyle(
                                                color: themeFlag
                                                    ? AppColors.metgoldenColor
                                                    : AppColors.blueZodiacTwo,
                                            ...
                                            TextSpan(
                                              text: AppLocalizations.of(context)!.logintext5,
                                              style: TextStyle(
                                                color: themeFlag
                                                    ? AppColors.metgoldenColor
                                                    : AppColors.blueZodiacTwo,
                                            ...
                                            TextSpan(
                                              text: AppLocalizations.of(context)!.logintext6,
                                              style: TextStyle(
                                                color: themeFlag
                                                    ? AppColors.metgoldenColor
                                                    : AppColors.blueZodiacTwo,
                                      ...
                                      children: [
                                        TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            prefixIcon: Icon(Icons.email_outlined, color: themeFlag
                                                ? AppColors.metgoldenColor
                                                : AppColors.blueZodiacTwo,),
                                            ...
                                            hintText: AppLocalizations.of(context)!.loginhinttext1,
                                            hintStyle: TextStyle(
                                              color: themeFlag
                                                  ? AppColors.metgoldenColor
                                                  : AppColors.blueZodiacTwo,
                                        ...
                                        TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            prefixIcon: Icon(Icons.lock_outline, color: themeFlag
                                                ? AppColors.metgoldenColor
                                                : AppColors.blueZodiacTwo,),
                                            contentPadding: EdgeInsets.symmetric(vertical: 0.0, horizontal: 12.0),
                                            border: OutlineInputBorder(
...
//AppLocalizations.of(context)!.signupbuttontext2,
              ...
              children: [
                ...
                CircleAvatar(
                  ...
                  child: FittedBox(
                    fit: BoxFit.cover,
                    child: Text(
                      AppLocalizations.of(context)!.logindevidtext.toUpperCase(),
                      style: TextStyle(
                        fontSize: 12.0,
                        //fontWeight: FontWeight.w600,
                        color: themeFlag
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Image.asset('assets/images/logo/applelogo.ico', height: 30.0, width: 30.0,),
                                SizedBox(width: 16.0,),
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Image.asset('assets/images/logo/Facebooklogo.png', height: 30.0, width: 30.0,),
                                SizedBox(width: 16.0,),
                                Text('Sign-In with Apple'),
                              ],
                            ),
                                ...
                                return GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        Image.asset('assets/images/logo/googlelogo.png', height: 30.0, width: 30.0,),
                                        SizedBox(width: 16.0,),
                                        Text('Sign-In with Apple'),
                                      ],
                                    ),
                  ...
                  children: [
                    GestureDetector(
                      ...
                      width: MediaQuery.of(context).size.width * 0.82,*/
                        ...
                        child: Image.asset('assets/images/logo/applelogo.ico', height: 30.0, width: 30.0,),
                        /*Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Image.asset('assets/images/logo/Facebooklogo.png', height: 30.0, width: 30.0,),
                      ),
                    ),
                    FutureBuilder(
                        future: Authentication.initializeFirebase(context: context),
                          ...
                          if (snapshot.hasError) {
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Image.asset('assets/images/logo/googlelogo.png', height: 30.0, width: 30.0,),
                              ),
                            );
                          }
                          return const CircularProgressIndicator(
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  child: Text(AppLocalizations.of(context)!.signupbuttontext2,
                    style: TextStyle(
                      decoration: TextDecoration.underline,
                      color: themeFlag
                          ? AppColors.metgoldenColor
